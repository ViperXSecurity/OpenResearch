...
typedef NTSTATUS(WINAPI* _NtCreateIoCompletion)(
...
typedef NTSTATUS(WINAPI* _NtSetIoCompletion)(
...
typedef NTSTATUS(WINAPI* _NtDeviceIoControlFile)(
    HANDLE FileHandle,
    HANDLE Event,
    PVOID ApcRoutine,
    PVOID ApcContext,
...
QWORD GetKernelBase();
QWORD setupIORing();
BOOL QueryObjectByPointer(HANDLE Handle, PVOID* ObjectAddress);
